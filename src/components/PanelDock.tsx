...
export default function PanelDock({ onHome, visible, showSwap, onSwap }: PanelDockProps) {
  if (!visible) return null;

  return (
    <div className="group/panel-dock pointer-events-auto absolute left-1/2 top-0 z-30 flex h-[52px] w-[104px] -translate-x-1/2 items-start justify-center px-3 pt-3">
